...
**Radial Basis Function (RBF)** é uma função definida no espaco euclidiano onde o valor de cada depende apenas de sua distância até a origem. Por exemplo uma radial function $$\phi$$ em duas dimensões tem a seguinte forma:
...
Conseguimos resolver o sistema através do médoto da matriz inversa para matrizes quadradas e o da pseudo inversa para as demais.
